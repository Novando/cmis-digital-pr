	...
	<div class="easyui-layout" style="width:100%;height:100%;">
		...
		<div data-options="region:'west',split:true" title="Look up &amp; Tools" style="width:200px;">
			...
			<script>
				...
				// Expert Approval Modal
				function expert_approval(){
					jQuery('#dialog-form').dialog('open').dialog('setTitle','Expert Approval');
					$('#frame1').attr('src', '<?php echo base_url('pr/expert_approval'); ?>');
					jQuery('#dialog-form').form('clear');
					reload();
				}
...
<div id="toolbar-rma" style="display: flex">
	...
	<!-- END OF CODE BY RIZKY@220225 -->
        ...
        <!-- #Body -->
        <div data-options="region:'center',title:'Expert Approval'" style="background-color:#D7E4F2;">
		<!-- TABLE UTAMA -->
		...
		data-options="
			...
			<tbody>
				<tr>
					...
					<td><span style="padding-left:25px; color:#DF0F0F; font-size: 25px">&#x2022;</span></td>
					<td></td>
					<td><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:true" onclick="expert_approval()"></a></td>
				</tr>
				<tr>
					<td>0003</td>
					<td><span style="padding-left:25px; color:#54CC1B; font-size: 25px">&#x2022;</span></td>
