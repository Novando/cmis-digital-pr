...
<div id="toolbar-rma" style="display: flex">
	...
	<?php //if ( $this->permissions->menu($menu_id, 'print') ) { ?>
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addnew()">New</a>
	<?php //} ?>
	...
	<?php //if ( $this->permissions->menu($menu_id, 'updated') ) { ?>
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="follow()">Delete</a>
	<?php //} ?>
	
	<?php if ( $this->permissions->menu($menu_id, 'verified') ) { ?>
	<?php if ( $this->uri->segment(2) == 'rma_log' ) { ?>
		<a href="#" class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="conf_log()">Confirm</a>
	<?php } ?>
	<?php } ?>
	...
	<?php } ?>
        ...
        <!-- #Body -->
        <div data-options="region:'center',title:'Purchase Request ( PR )'" style="background-color:#D7E4F2;">
		<!-- TABLE UTAMA -->
		...
		data-options="
			...
			<thead>
				<tr>
					...
					<th field="report_date" width="100" sortable="true" align="center">Status</th>
